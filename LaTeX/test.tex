...
Ostatecznie to ostatnie, ściśle zdefiniowane środowisko okazało się najwygodniejsze do stabilnej obserwacji interakcji w duchu koewolucji, podczas gdy bardziej rozbudowane symulacje dawały mniej przejrzysty obraz dynamiki.
\end{abstract}
...
Świat jest dwuwymiarową siatką; agenci poruszają się w osiem sąsiadów Moore'a (także po przekątnych) lub pozostają na miejscu, w zależności od implementacji interfejsu.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{1.6cm}p{1.4cm}p{4.8cm}p{2.5cm}p{1.7cm}@{}}
    ...
    \midrule
    Siatka 2D & 8 kier.\ (+ ewent.\ bez ruchu) & Energia: ruch kosztuje; 0 = śmierć. Diety i padlina jak wyżej. Rośliny: spawn + sąsiedztwo. Drapieżniki bez losowego dosiewu; ofiary rzadko losowo. & Progi po roślinie / ofierze lub padlinie & Brak \\
    \bottomrule
  \end{tabular}
  \end{adjustbox}
\end{table}
...
\begin{figure}[htbp]
  ...
  \caption{Pierwszy system: przykładowe oscylacje liczebności roślin, ofiar i drapieżników w czasie.}
  \label{fig:sys1-pop}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Pierwszy system: widoczne fale przestrzenne (ofiara przed drapieżnikiem w pasach zajętości siatki).}
  \label{fig:sys1-fale}
\end{figure}
...
\textbf{Pole i ruch.} Siatka 2D; ruch w kierunkach również przekątnych.

\textbf{Życie i śmierć.} Drapieżniki giną z głodu. Ofiary giną po schwyceniu lub ze starości.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{1.6cm}p{1.4cm}p{4.6cm}p{2.4cm}p{2.0cm}@{}}
    ...
    Pole & Ruch & Zasady & Rozmnażanie & Param.\ / ewo\-lucja \\
    \midrule
    Siatka 2D & 8 kier.\ (+ przekątne) & Głód drapieżników; ofiary: schwycenie lub wiek. Koewolucja cech (RPS); stamina + regen. & Ofiary spontanicznie; drapieżniki po ofierze & Wieloczynnikowy genotyp; GA \\
    \bottomrule
  \end{tabular}
  \end{adjustbox}
\end{table}
...
\begin{figure}[htbp]
  ...
  \caption{Drugi system: przykład przebiegu przy braku ewolucji ofiar (scenariusz referencyjny).}
  \label{fig:sys2-1}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Drugi system: ewolucja ofiar, wygaszenie specjalizacji i brak nowych cech.}
  \label{fig:sys2-2}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Drugi system: brak wyraźnych cykli przy ewolucji obu stron i małych zmianach strategii.}
  \label{fig:sys2-3}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Drugi system: cykle populacji przy mutacji naprzemiennie tylko jednej grupy --- rozwój skoncentrowany w jednej cesze.}
  \label{fig:sys2-4}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Drugi system: łagodniejsze cykle przy dłuższych okresach periodycznej mutacji jednej grupy.}
  \label{fig:sys2-5}
\end{figure}
